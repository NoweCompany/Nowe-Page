    ...
    <>
      <div className={style.containerCenter}>
          ...
          <h1 className={style.title}>
            weon <span className={style.dot}>.</span>
          </h1>
        <h2 className={style.Maintext}>
          ...
          , a Weon capacita os usuários a transformar dados brutos em
          conhecimento acionável. Ao colocar o usuário no controle e explorar o
          potencial total dos dados, a Weon se torna a ferramenta essencial para
          impulsionar a eficácia das decisões.
        </h2>
      </div>
    </>
  );
